...
assert.match(enabled, /AI_CORE_PUBLIC_RUNTIME_SHA=5713258de76d4aa689baf30eae016df54cd8d579/);
assert.match(enabled, /AI_CORE_PUBLIC_CONTRACT_SHA=8834367e7412656b5a83d0c01b05dbffae6d3dee/);
