...
BASE_SITE_SHA = "243b831ef8f15733dd60e27d63d57c71d2a4113e"
RUNTIME_SHA = "78db9e3c3363720fe680056873b41b332f319b96"
ROLLBACK_RUNTIME_SHA = "da7a8f3fe3859fd46df1fb8d0387863ac0b8bb07"
...
RUNTIME_RELEASE_DIR = "release/ai-core-runtime-78db9e3c"
ROLLBACK_RELEASE_DIR = "release/ai-core-runtime-da7a8f3"
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="rospark-site-pin-78db-") as raw:
        temp = Path(raw)
        root = temp / f"PUBLIC_AI_CORE_SITE_PIN_78DB9E3C_{site_sha[:8]}"
