const packages = [
  {
    ...
    title: "Автоматический выезд без оплаты",
    description:
    ...
    features: [
      ...
      "Автоматический выезд по заданному правилу",
    ],
    priceFrom: "245 000 ₽",
    highlight: false,
  },
  {
    level: "Автоматизация",
    title: "Въезд по номеру автомобиля",
    description:
      "Автоматизированный доступ с распознаванием госномера для объектов с контролем потоков.",
    scope: "Оптимально для бизнес-центров, торговых центров и жилых комплексов.",
    features: [
      "Камера ГРНЗ",
      "ПО управления парковкой",
      "ПО распознавания",
      "Бокс управления проездом",
      "Шлагбаум РОСПАРК",
    ],
    priceFrom: "865 000 ₽",
    highlight: false,
  ...
  {
    level: "Платная парковка под управлением",
    title: "Автоматическая парковка",
    description:
      "Система без билетов и карт, по собственному идентификатору клиента для объектов с высокой проходимостью и прозрачным учётом выручки.",
    scope: "Рекомендуется для объектов с высоким трафиком.",
    features: [
      "Комплект оборудования",
      "Сценарии въезда/выезда",
      "Отчёты и панель управления",
      "Постоянные, гостевые и разовые клиенты",
      "Оплата на выезде банковской картой",
    ],
    priceFrom: "1 250 000 ₽",
    highlight: false,
  },
  {
    ...
    description:
      "Полноценная система управления парковочным активом с интеграцией в ИТ-контур объекта.",
    scope: "Рекомендуется для девелоперов и сетевых объектов.",
    features: [
      "Комплект оборудования",
      "Абонементы и роли доступа",
      "Интеграции и программные интерфейсы",
      "Оплата через сайт и уведомления",
    ],
    priceFrom: "1 700 000 ₽",
    highlight: true,
  },
      ...
      <div className="mx-auto w-full max-w-6xl min-w-0 px-4 sm:px-6">
        ...
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-[32px] font-extrabold leading-tight tracking-tight text-slate-900 md:text-5xl">
            Форматы внедрения и развития системы
          </h2>
        ...
        <p className="mt-8 text-center text-sm text-slate-500">
          Итоговая конфигурация и бюджет формируются после обследования объекта.
