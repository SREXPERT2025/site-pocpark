          ...
          section.innerHTML = [
            '<div class="parkovka-ai-promo">',
              '<div class="parkovka-ai-promo__copy">',
                ...
                '<h2 id="parkovka-ai-promo-title">Опишите задачу онлайн-консультанту РОСПАРК</h2>',
                '<p class="parkovka-ai-promo__description">Расскажите своими словами, что сейчас происходит на въезде или парковке. Консультант поможет разобраться в вариантах и подскажет, с чего начать.</p>',
                '<p class="parkovka-ai-promo__context" aria-live="polite">Выберите проблему выше — консультант учтёт её в вопросе.</p>',
                '<div class="parkovka-ai-promo__questions"></div>',
                '<button type="button" class="parkovka-ai-promo__cta">Задать вопрос по парковке</button>',
              '</div>',
              '<div class="parkovka-ai-promo__visual" aria-hidden="true">',
                ...
                '<div class="parkovka-ai-promo__chat">',
                  '<div class="parkovka-ai-promo__chat-head"><span class="parkovka-ai-promo__spark">✦</span><span>Онлайн-консультант РОСПАРК</span></div>',
