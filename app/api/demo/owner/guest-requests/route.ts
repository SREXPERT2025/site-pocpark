...
import { getOwnerGuestRequests } from '@/app/lib/demo-owner-report-service';
...
export async function GET(request: NextRequest) {
  ...
  try {
    return NextResponse.json(getOwnerGuestRequests(sessionId, request.nextUrl.searchParams));
  } catch (error) {
