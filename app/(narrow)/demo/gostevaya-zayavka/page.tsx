...
const faq = [
  ...
  },
  {
    ...
    answer:
      'В отдельной demo-базе на сервере: пользовательские записи хранятся не более 24 часов. Публичная ссылка открывается на другом устройстве, а телефон гостя на публичной странице скрыт.',
  },
  {
