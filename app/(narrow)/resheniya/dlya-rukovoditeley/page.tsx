...
export const metadata: Metadata = {
  "title": "Автоматизация парковки для руководителей — выручка и загрузка",
  "description": "Решения РОСПАРК для директоров и управляющих: учёт выручки, контроль загрузки, автоматизация проезда и оплаты. Предварительная оценка после получения исходных данных.",
  "keywords": [
  ...
  const answerBullets =
    answerFirst?.bullets?.length
      ...
      : [
          ...
          'Готовите обоснование: предварительная оценка после получения исходных данных.',
        ];
