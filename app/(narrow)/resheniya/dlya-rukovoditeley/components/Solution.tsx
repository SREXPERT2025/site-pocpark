        ...
        <div className="grid min-w-0 max-w-full md:grid-cols-2 gap-10 md:gap-12 items-start">
          ...
          <div className="space-y-10">
            ...
            <div className="flex gap-4 md:gap-5 min-w-0">
              ...
              <div className="min-w-0">
                <h3 className="text-base md:text-lg font-bold mb-2 text-slate-900 break-words leading-snug">
                  Автоматические сценарии 24/7
                </h3>
                <p className="text-slate-600 break-words">
                  Система управляет шлагбаумами, терминалами оплаты и
                  распознаванием номеров по настроенным правилам. Ответственные
                  сотрудники подключаются к исключениям и спорным ситуациям.
                </p>
              </div>
            </div>
