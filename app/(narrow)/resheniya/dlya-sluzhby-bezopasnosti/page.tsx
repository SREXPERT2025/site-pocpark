...
export const metadata: Metadata = {
  "title": "Автоматизация парковки для службы безопасности — события и доступы",
  "description": "РОСПАРК для службы безопасности: контроль въезда и выезда, фотофиксация, журнал событий, стоп-листы, гостевые сценарии, роли доступа и локальные режимы работы.",
  "keywords": [
