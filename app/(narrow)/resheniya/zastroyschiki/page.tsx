        ...
        <div className="container mx-auto max-w-6xl min-w-0 px-4">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            <div className="min-w-0 overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 break-words text-slate-700">Резиденты, арендаторы, гости, подрядчики — разные правила и уровни доступа.</p>
            </div>
            <div className="min-w-0 overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              <h3 className="break-words text-lg font-semibold text-slate-900">Контроль гостевых пропусков</h3>
              <p className="mt-2 break-words text-slate-700">Заявки, подтверждения, ограничение времени и количества въездов.</p>
            </div>
            <div className="min-w-0 overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="container mx-auto max-w-6xl min-w-0 px-4">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            ...
            <div className="min-w-0 overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 break-words text-slate-700">Журналы событий, поддержка, регламент инцидентов.</p>
            </div>
            <div className="min-w-0 overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
