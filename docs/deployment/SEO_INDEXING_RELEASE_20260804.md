...
4. главная, `/demo`, `/parkovka` и `/parkovka-pod-klyuch` отвечают `200`;
5. PM2 online, Nginx active, timers active;
6. `LEADS_CREATED=0`, `MAX_MESSAGES_SENT=0`.
