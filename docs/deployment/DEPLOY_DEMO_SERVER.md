...
> Исторический документ для прежнего Windows demo-сервера, подготовленный
> 2026-05-03. Он не описывает текущий Linux/Nginx production и не должен
> использоваться как команда на выпуск. Актуальный контекст:
> `docs/production/PRODUCTION_STATE_2026_07_23.md`; ручной runbook:
> `docs/deployment/AFTER_DEPLOY_GUEST_DEMO_MAX.md`.

Статус: историческая документация v1
Дата: 2026-05-03
