...
4. ответственного за claim ledger;
5. утверждённый FAQ и знания AI-виджета;
6. допустимую схему размещения AI-виджета и локального model gateway;
7. срок хранения диалогов и лидов AI-виджета.
