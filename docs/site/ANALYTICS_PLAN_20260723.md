...
проверены; следующий этап — `ANALYTICS-001-C`
...
Сбор базовых pageview начат 2026-07-24. До настройки целей, накопления данных и
появления серверной связи пока нельзя достоверно получить:
...
- проверка поступления pageview и goals в интерфейсе Метрики.
