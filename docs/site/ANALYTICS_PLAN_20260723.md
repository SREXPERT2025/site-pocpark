...
входа в demo/quiz; consent-gated интеграция GA4 подготовлена локально и ожидает
Measurement ID и накопительного production-релиза
...
### 4.1. Локальное расширение GA4 от 2026-07-28
...
- Политика обработки персональных данных дополнена описанием GA4 и способом
  отзыва согласия;
- пакет ещё не опубликован на VPS и production environment пока не содержит
  новый Measurement ID.
