...
## 2026-07-28 — локальная подготовка Google Analytics 4
...
- пакет включён в накопленный редизайн и ещё не опубликован на VPS.
...
- пакет ещё не опубликован на VPS и должен войти в следующий накопленный
  релиз.
